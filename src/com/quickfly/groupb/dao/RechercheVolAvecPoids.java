...
public class RechercheVolAvecPoids implements StrategieRecherche
{
	private DaoFactory daofactory;
	
	public RechercheVolAvecPoids(DaoFactory daofactory) {
		super();
		this.daofactory = daofactory;
	}

	
	public RechercheVolAvecPoids() {
		super();
	}
	...
	public ArrayList<Vol> RechercherVol(String villedep, String villearr, String datedep, double poids) {
		...
		try {
			...
			preparedStatement = connexion.prepareStatement("SELECT * FROM vol where villeDepart =? and villearrivee =? and datedepart=? and poidsaut>=?");
